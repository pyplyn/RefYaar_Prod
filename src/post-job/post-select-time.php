        ...
        <table id="example" class="table-bordered table-hover table-responsive table table-striped table-bordered" cellspacing="0" width="100%">
            ...
            <tbody>
                ...
                if ($_GET["key"] == "Location") {
                    ...
                    $Query = "select a.organization,a.headline,c.area,a.min_req_exp,a.max_req_exp,b.city,a.status,a.post_time from job_post a,location__city b, func_area c where a.city_id=b.id and a.func_area_id=c.id and a.post_time=? order by a.post_time desc";
                    $stmt = $con->prepare($Query);
